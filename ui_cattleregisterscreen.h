...
public:
    ...
    void setupUi(QDialog *CattleRegisterScreen)
    {
        ...
        birthButton->setGeometry(QRect(80, 240, 531, 71));
        ...
        backButton->setGeometry(QRect(80, 340, 531, 71));
