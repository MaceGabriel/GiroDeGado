...
public:
    ...
    void setupUi(QDialog *CattleConsultScreen)
    {
        ...
        cattleTransactionTable->setGeometry(QRect(0, 230, 211, 181));
    ...
    {
        CattleConsultScreen->setWindowTitle(QCoreApplication::translate("CattleConsultScreen", "Tela de Consulta de Gado", nullptr));
