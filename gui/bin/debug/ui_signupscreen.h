...
public:
    ...
    void setupUi(QDialog *SignUpScreen)
    {
        ...
        labelPassword->setGeometry(QRect(40, 360, 61, 16));
        ...
        inputPassword->setGeometry(QRect(40, 380, 311, 41));
        ...
        inputPassword_2->setGeometry(QRect(550, 385, 311, 41));
